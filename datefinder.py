...
class DateFinder(object):
    ...
    DAYS_PATTERN = 'maandag|dinsdag|woensdag|donderdag|vrijdag|zaterdag|zondag|ma|di|woe|do|vrij|zat|zondag'
    ...
    MONTHS_PATTERN = 'januari|februari|maart|april|mei|juni|juli|augustus|september|oktober|november|december|jan|feb|mar|apr|may|jun|jul|aug|sep|sept|oct|nov|dec'
    ...
    EXTRA_TOKENS_PATTERN = 'tegen|by|op|standard|daylight|savings|time|tijd|datum|of|to|tot|until|z|at|t'

    ## TODO: Get english numbers?
    ## http://www.rexegg.com/regex-trick-numbers-in-english.html

    RELATIVE_PATTERN = 'before|voor|after|na|next|last|ago'
    TIME_SHORTHAND_PATTERN = 'noon|midnight|today|yesterday'
    UNIT_PATTERN = 'second|seconde|minute|minuten|hour|uur|day|dag|week|month|maand|year|jaar'
